...
**LastFullSyncTimestamp** | **string** | Timestamp of the last full audit log collection | [default to null]
**Results** | [**[]AuditLog**](AuditLog.md) | Audit log results | [default to null]
