...
**Results** | [**[]BaseServiceInstance**](BaseServiceInstance.md) | List of the Service-Insertion ServicesInstances. The list has to be homogenous. | [optional] [default to null]
