...
**Start** | **int64** | Start value for vni range to be used for virtual networks | [default to null]
**End** | **int64** | End value for vni range to be used for virtual networks | [default to null]
