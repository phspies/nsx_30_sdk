...
**NsGroupId** | **string** | NSGroup ID | [optional] [default to null]
**Results** | [**[]IdfwVmDetail**](IdfwVmDetail.md) | List of user login/session data for a single VM | [default to null]
