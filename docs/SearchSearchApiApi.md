...
------------- | ------------- | -------------
[**DslSearch**](SearchSearchApiApi.md#DslSearch) | **Get** /search/dsl | DSL (Domain Specific Language) search API
[**QuerySearch**](SearchSearchApiApi.md#QuerySearch) | **Get** /search/query | Full text search API
 ...
 **optional** | ***SearchSearchApiApiDslSearchOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a SearchSearchApiApiDslSearchOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **query** | **string**| Search query | 
 **optional** | ***SearchSearchApiApiQuerySearchOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a SearchSearchApiApiQuerySearchOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
