...
**LinkedLogicalRouterPortId** | [***ResourceReference**](ResourceReference.md) |  | [optional] [default to null]
**EdgeClusterMemberIndex** | **[]int64** | Please use logical router API to pass edge cluster members indexes manually.  | [optional] [default to null]
