...
**Results** | [**[]LogicalPortMacTableEntry**](LogicalPortMacTableEntry.md) |  | [optional] [default to null]
**TransportNodeId** | **string** | Transport node identifier | [optional] [default to null]
