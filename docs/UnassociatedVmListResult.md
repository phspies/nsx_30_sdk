...
**LastUpdateTimestamp** | **int64** | Timestamp in milliseconds since epoch | [optional] [default to null]
**Results** | [**[]VirtualMachine**](VirtualMachine.md) | List of VMs which are not associated with any NSGroup  | [default to null]
