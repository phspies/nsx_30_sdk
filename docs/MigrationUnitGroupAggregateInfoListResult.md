...
**Results** | [**[]MigrationUnitGroupAggregateInfo**](MigrationUnitGroupAggregateInfo.md) | Paged collection of migration status for migration unit groups | [optional] [default to null]
