...
**Results** | [**[]UpgradeUnitGroupAggregateInfo**](UpgradeUnitGroupAggregateInfo.md) | Paged collection of upgrade status for upgrade unit groups | [optional] [default to null]
