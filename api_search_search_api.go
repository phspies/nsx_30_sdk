...
type SearchSearchApiApiService service
/*
SearchSearchApiApiService DSL (Domain Specific Language) search API
DSL (Domain Specific Language) search API
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param query Search query
 * @param optional nil or *SearchSearchApiApiDslSearchOpts - Optional Parameters:
...
type SearchSearchApiApiDslSearchOpts struct { 
...
func (a *SearchSearchApiApiService) DslSearch(ctx context.Context, query string, localVarOptionals *SearchSearchApiApiDslSearchOpts) (SearchResponse, *http.Response, error) {
	var (
...
/*
SearchSearchApiApiService Full text search API
Full text search API
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param query Search query
 * @param optional nil or *SearchSearchApiApiQuerySearchOpts - Optional Parameters:
     * @param "Cursor" (optional.String) -  Opaque cursor to be used for getting next page of records (supplied by current result page)
     * @param "IncludedFields" (optional.String) -  Comma separated list of fields that should be included in query result
     * @param "PageSize" (optional.Int64) -  Maximum number of results to return in this page (server may return fewer)
     * @param "SortAscending" (optional.Bool) - 
...
type SearchSearchApiApiQuerySearchOpts struct { 
	Cursor optional.String
	IncludedFields optional.String
	PageSize optional.Int64
	SortAscending optional.Bool
...
func (a *SearchSearchApiApiService) QuerySearch(ctx context.Context, query string, localVarOptionals *SearchSearchApiApiQuerySearchOpts) (SearchResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
